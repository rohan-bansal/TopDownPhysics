...
public class CarManager {
    ...
    public enum CarModel {
        MUSTANG, AERO, LAMBORGHINI, RED_TRUCK, FORMULA_BLUE
    }
    ...
    private static Car processModel(CarModel model, Vector2 position, float angle, World world) {
        ...
        if(model == CarModel.MUSTANG) {
            ...
            temp = new Car(properties);
        } else if(model == CarModel.FORMULA_BLUE) {
            CarProperties properties = new CarProperties(position, 170, 0.2f, 100, 0.4f, angle, CarType.TWO_WHEEL_DRIVE, world, "cars/formula_blue.png");
