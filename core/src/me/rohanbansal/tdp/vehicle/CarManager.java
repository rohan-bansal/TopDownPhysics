...
public class CarManager {
    ...
    private static Car processModel(CarModel model, Vector2 position, float angle, World world) {
        ...
        if(model == CarModel.MUSTANG) {
            CarProperties properties = new CarProperties(position, 80, 0.4f, 90, 0.4f, angle, 80, CarType.TWO_WHEEL_DRIVE, world, "cars/car_black_yellowstripes.png");
            ...
            CarProperties properties = new CarProperties(position, 110, 0.5f, 110, 0.5f, angle, 70, CarType.TWO_WHEEL_DRIVE, world, "cars/car_purple.png");
            ...
            CarProperties properties = new CarProperties(position, 115, 0.4f, 150, 0.5f, angle, 60, CarType.TWO_WHEEL_DRIVE, world, "cars/car_red.png");
            ...
            CarProperties properties = new CarProperties(position, 70, 0.0f, 10, 0.3f, angle, 150, CarType.FOUR_WHEEL_DRIVE, world, "cars/thick_truck_red.png");
            ...
            CarProperties properties = new CarProperties(position, 70, 0.0f, 25, 0.35f, angle, 140, CarType.TWO_WHEEL_DRIVE, world, "cars/pickup_truck.png");
            ...
            CarProperties properties = new CarProperties(position, 170, 0.2f, 100, 0.4f, angle, 65, CarType.TWO_WHEEL_DRIVE, world, "cars/" + model.name().toLowerCase() + ".png");
